...
// linuxTypes.h
//
// Copyright (C) 2021 Mark Russinovich and Thomas Garnier
//
// defines and typedefs to map to Windows types.
//
//====================================================================

// Some of this was borrowed from WinNT.h and other headers found via
// the Internet.
...
typedef uint64_t CRITICAL_SECTION;
